...
export const PointCloudViewer: React.FC = () => {
  ...
  const [transformDistance, setTransformDistance] = useState<number | null>(null);
    ...
    return (
      <>
        ...
        <TransformManipulator
          ...
          onDistanceChange={setTransformDistance}
        />
  ...
  return (
    <div className="w-full h-screen bg-gray-900 relative">
      ...
      {transformDistance !== null && (
        <div className="absolute top-16 left-1/2 -translate-x-1/2 z-20 bg-black/80 text-white px-2 py-1 rounded">
          {transformDistance.toFixed(2)} m
        </div>
      )}
